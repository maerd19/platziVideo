...
ReactDOM.render(
  // Se encapsula nuestra App dentro de un provider. Nada fuera del provider podrá acceder al store.
  // El Provider hace que la store esté disponible para cualquier componente anidado que se haya incluido en la función connect().
